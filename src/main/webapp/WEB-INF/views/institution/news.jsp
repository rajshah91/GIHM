...
<t:dashboard>
    <jsp:attribute name="header">
        <script type="text/javascript" src="<c:url value='/resources/js/jschool/institution/news.js' />"></script> 
            ...
            <div class="col-md-12">
                <div class="box box-default" data-collapsed="0">
                    <div class="box-header with-border">
                        <div class="box-title">
                            <span><i class="fa fa-plus"></i>News Entry</span>                
                        </div>
                    </div>
                    <div class="box-body">
                        <form name="addNewsForm" action="#" method="post" class="form-horizontal" id="addNewsForm" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="">Title<span class="require-field">*</span></label>
                                <div class="col-sm-8">
                                    <input id="newstitle" class="form-control validate[required]" type="text" value="" name="newstitle" aria-describedby="newstitle" >
                             ...
                             <div class="form-group">
                                <label class="col-sm-2 control-label" for="">Description<span class="require-field">*</span></label>
                                <div class="col-sm-8">
                                    <input id="newsdesc" class="form-control validate[required]" type="text" value="" name="newsdesc" aria-describedby="newsdesc" maxlength="200">
                                    <small id="courseHelp" class="form-text text-muted bg-info">
