...
<t:dashboard>
    <jsp:attribute name="header">
        <script type="text/javascript" src="<c:url value='/resources/js/jschool/institution/courseSubject.js' />"></script> 
                ...
                <div class="box box-default" data-collapsed="0">
                    <div class="box-header with-border">
                        <div class="box-title">
                            <span><i class="fa fa-plus"></i>
                                Course Subject Mapping</span>                
                        </div>
                    </div>
                    <div class="box-body">
                        <form name="addCourseSubjectForm" action="#" method="post" class="form-horizontal" id="addCourseSubjectForm" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        <div class="box-body table-responsive">
                            <table id="courseSubjectTable" class="table table-bordered table-striped">
                            </table>
                        </div><!-- /.box-body -->
                    </div>
                </div>
