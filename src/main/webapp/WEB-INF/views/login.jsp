...
<html>
    ...
    <style type="text/css">
        body { 
            background: url('resources/images/college.jpg') no-repeat center center fixed; 
...
<body style="background-image: url('resources/images/college.jpg');" >
   
    <!--<body style="background-image:url(/resources/images/college.jpg);height: 100%;background-position: center;background-repeat: no-repeat; background-size:100% 100vh;" background="<c:url value='/resources/images/college.jpg' />">-->
        ...
        <c:choose>
            ...
            <c:otherwise>
                <div class="login-page">
                    <div class="form">
                        <span>
                            <image src="resources/images/GIHM_LOGO.png" height="100px" />
                        </span>
