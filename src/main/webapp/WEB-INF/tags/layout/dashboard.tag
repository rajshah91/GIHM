...
<html>
  <head>
    ...
    <title>Gujarat Institute Of Hotel Management</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="http://javabase.info" class="logo" target="_blank">
          ...
          <span class="logo-mini"><b><img src="<c:url value="/resources/images/schoolLogo.png"/>" class="img-circle" alt="School Logo" height='50' width="50"></b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg">GIHM</span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                 ...
                 <%--  <img src='<c:url value="/resources/images/user/${userInfo.userLogo}"/>' class="img-circle"> --%>
                  <!-- hidden-xs hides the username on small devices so only the image appears. -->
                  <span class="hidden-xs">${fn:toUpperCase(user.username)}</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- The user image in the menu -->
                 <%--  <li class="user-header">
                    <img src='<c:url value="/resources/images/user/${userInfo.userLogo}"/>' class="img-circle" alt="avater Image">
                    <p>
